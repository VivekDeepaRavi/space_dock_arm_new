...
position_publisher = rospy.Publisher('object_position', Float32, queue_size=10)
...
while not rospy.is_shutdown():
    ...
    frame[:top_portion_height, :] = (255, 255, 255)  # White color
    frame[bottom_portion_height:, :] = (255, 255, 255)  # White color
